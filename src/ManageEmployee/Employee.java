...
public class Employee {
	 ...
	 * add employee method
	 */
	public boolean addEmployee(String userid, String name, long phone, String department, String level, long salary,
	 ...
	 * modifying employee
	 */
	public boolean modifyEmployee(String userid, String name, long phone, String department, String level, long salary,
			String dob, String address) {
		try {
			Connection connection = DatabaseConnection.getConnection();
			if (!searchEmployee(userid)) {
